...
exports.create = (req, res) => {
    ...
    if (!req.body.phone || !req.body.email || !req.body.address || !req.body.location || !req.body.web || !req.body.trade_name) {
...
exports.findAll = (req, res) => {
    ...
    const type = req.query.phone;
    var condition = phone ? { [Op.and]: [{phone: { [Op.like]: `%${phone}%` }, deletedAt: null }]} : {deletedAt: null};
